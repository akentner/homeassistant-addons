...
**Two-stage Dockerfile (oven/bun:1 build + HA amd64-base:3.22 runtime) with GitHub tarball fetch and auto-update
wiring for rynfar/meridian v1.26.6**
...
**Total deviations:** 1 auto-adjusted (worktree pre-commit config state)
**Impact on plan:** No scope creep — D-15 was already planned; worktree divergence required covering both the previous
pattern and the new meridian addition.
